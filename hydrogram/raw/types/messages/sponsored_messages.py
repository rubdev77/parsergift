...
class SponsoredMessages(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        start_delay (``int`` ``32-bit``, *optional*):
            For sponsored messages to show on channel videos », the number of seconds to wait before showing the first ad.

        between_delay (``int`` ``32-bit``, *optional*):
            For sponsored messages to show on channel videos », the number of seconds to wait after the previous ad is hidden, before showing the next ad.
