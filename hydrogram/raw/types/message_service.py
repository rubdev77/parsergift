...
class MessageService(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        saved_peer_id (:obj:`Peer <hydrogram.raw.base.Peer>`, *optional*):
            Will only be set for service messages within a monoforum topic »: peer will be equal to the ID of the monoforum and the saved_peer_id flag will be set to the ID of a topic.
