...
class Channel(TLObject):  # type: ignore
    ...
    Parameters:
        ...
        autotranslation (``bool``, *optional*):
            If set, autotranslation was enabled for all users by the admin of the channel, as specified here ».

        broadcast_messages_allowed (``bool``, *optional*):
            If set, this channel has an associated monoforum », and its ID is specified in the linked_monoforum_id flag.

        monoforum (``bool``, *optional*):
            If set, this is a monoforum », and the ID of the associated channel is specified in the linked_monoforum_id.
        ...
        linked_monoforum_id (``int`` ``64-bit``, *optional*):
            For channels with associated monoforums, the monoforum ID. For Monoforums, the ID of the associated channel.
